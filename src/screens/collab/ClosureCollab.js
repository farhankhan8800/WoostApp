...
const ENDPOINT = '/campaignform/campaignclosureform';
const ENDURL ='/campaignform/campaignclosuresubmit';
...
const ApplyCollab = ({navigation,route}) => {
  ...
  const getDetails = () => {
    ...
    request.post(navigation,Config.API_URL + ENDPOINT, {
        ...
        console.log('RequestClosure',data);
  ...
  if (emptyFields.length > 0) {
    ...
    return;
          ...
          request.post(navigation,Config.API_URL + ENDURL,formDataPrepare , {
            ...
            console.log('RequestResponseClosureForm',data);
            if (data.code == 1 && data.error == 0) 
            {  
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <View style={styles.bottemSheet}>
        ...
        <View style={{ paddingTop: 10 }}>
          <Text style={styles.enter_amount_title}>You have Successfully filled closure of this campaign</Text>
          <View>
